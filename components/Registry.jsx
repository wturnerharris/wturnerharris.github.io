...
function Registry({ location }) {
  ...
  return (
    <section id="Registry" className="fullscreen page">
      ...
      <p>You can visit any of the below registries, or visit <a href={theknot}>theknot.com</a> to see our entire wish-list on one page!</p>
      <p><a href={target}>Target</a></p>
      <p><a href={amazon}>Amazon</a></p>
      <p><a href={bbb}>Bed Bath & Beyond</a></p>
      <p><a href={cb1}>Crate & Barrel</a></p>
    </section>
  );
}
