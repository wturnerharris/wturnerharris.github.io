...
function Dress({ children }) {
  return (
    <section id="Dress" className="fullscreen page">
      ...
      <p> If you are unsure what might be appropriate, please check out our <a href="https://www.pinterest.com/jamelazarha/dress-code/">pinterest</a> board with inspiration for what to wear on our special night out.</p>
    </section>
  );
}
